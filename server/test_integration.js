async function testBackendEndToEnd() {
    try {
        ...
        const roadmapRes = await fetch('http://127.0.0.1:5001/api/ai/roadmap', {
            method: 'POST',
            headers: { 
        ...
        console.log("Number of generated chunks/phases:", roadmapData.roadmap?.steps?.length);
        console.log("\nPreview of Phase 1:");
        console.log(JSON.stringify(roadmapData.roadmap?.steps?.[0], null, 2));
