                ...
                >
                  {notif.status === 'confirmed' ? (
                    <p className="text-sm text-gray-800">
                      Your session for{' '}
                      <span className="font-semibold text-sky-600">{skillName}</span> with{' '}
                      <span className="font-semibold">{instructorName}</span> is confirmed for{' '}
                    ...
                    <p className="text-sm text-gray-800">
                      Your booking for{' '}
                      <span className="font-semibold text-sky-600">{skillName}</span> with{' '}
                      <span className="font-semibold">{instructorName}</span> for{' '}
                      <span className="font-semibold">
                        {new Date(notif.date).toLocaleString([], {
                          weekday: 'long',
                          year: 'numeric',
                      ...
                      has been <span className="font-bold text-red-600">cancelled</span>.
                    </p>
                  )}
              ...
              return (
                ...
                >
                  <p className="text-sm text-gray-800">
                    ...
                    <span className="font-semibold">{studentName}</span> for{' '}
                    <span className="font-semibold text-sky-600">{skillName}</span>.
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
