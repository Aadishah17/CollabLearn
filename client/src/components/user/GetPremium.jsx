...
export default function GetPremium() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-black flex items-start justify-center">
      <div className="w-full max-w-6xl mx-6 bg-black rounded-2xl shadow-xl overflow-hidden border border-white">
