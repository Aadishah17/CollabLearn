...
const PostPage = () => {
  ...
  return (
    <>
      <MainNavbar />
      <div className="bg-black min-h-screen font-sans pt-20">
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <Link to="/community" className="flex items-center text-red-500 hover:text-red-400 mb-4">
            ...
            <div className="bg-black border border-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    <span className="bg-red-900/30 text-red-500 text-xs font-semibold px-2 py-0.5 rounded-full">
                      #{post.category}
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-4">
                ...
                <p className="text-gray-300 mt-2 text-base">{post.excerpt}</p>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <textarea
                      ...
                      className="w-full px-3 py-2 bg-black border border-white rounded-lg text-sm text-white focus:ring-2 focus:ring-red-500 placeholder:text-gray-500"
                      rows="3"
                    ></textarea>
                    <div className="mt-2 flex justify-end">
                      <button
                        ...
                        className="px-4 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 shadow-sm disabled:bg-red-400 disabled:cursor-not-allowed"
                      >
                        Post Comment
                      </button>
                    </div>
                  ...
                  {comments.length > 0 ? (
                    comments.map((comment, index) => (
                      <div key={index} className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 bg-gray-900 border border-gray-700 p-3 rounded-lg">
                          <div className="flex items-center justify-between">
