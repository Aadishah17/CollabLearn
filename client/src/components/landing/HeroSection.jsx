import { ArrowRight, Clock3, MessageSquare, Sparkles, Target, TrendingUp, Users } from 'lucide-react';
...
export default function HeroSection({ hasSession, userRole, isSuperAdmin }) {
  ...
  return (
    <section className="hero-stage hero-beam relative overflow-hidden px-6 pb-12 pt-24 md:pb-18 md:pt-28 lg:pb-20 lg:pt-32" aria-label="Introduction">
      <div className="ambient-grid pointer-events-none absolute inset-x-0 top-0 h-[520px] opacity-30" aria-hidden="true" />
      ...
      <div className="mx-auto grid max-w-[1480px] items-start gap-8 md:gap-10 lg:min-h-[calc(100svh-8.5rem)] grid-cols-1 lg:grid-cols-[minmax(0,0.5fr)_minmax(520px,0.5fr)]">
        ...
        <div className="relative z-10 reveal-up reveal-delay-2 lg:pt-3">
          <div className="surface-card dashboard-shell hero-stage glow-frame orbit-shell float-drift relative min-h-[540px] overflow-hidden rounded-[36px] p-5 md:p-6 lg:min-h-[620px]" role="region" aria-label="Live product preview">
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-white/4 via-transparent to-red-500/6" aria-hidden="true" />
            <div className="pointer-events-none absolute right-8 top-10 h-28 w-28 rounded-full bg-blue-500/12 blur-3xl" aria-hidden="true" />
            <div className="pointer-events-none absolute inset-y-0 left-[58%] hidden w-px bg-gradient-to-b from-transparent via-white/10 to-transparent lg:block" aria-hidden="true" />
            ...
            <div className="relative mt-5 grid gap-4 lg:grid-cols-[1.06fr_0.94fr]">
              ...
              <div className="space-y-4">
                ...
                <div className="glow-frame rounded-[24px] border border-blue-400/18 bg-blue-500/[0.08] p-4">
                  ...
                  <div className="mt-4 h-3 overflow-hidden rounded-full bg-white/8" role="progressbar" aria-valuenow={68} aria-valuemin={0} aria-valuemax={100} aria-label="68% of monthly milestones completed">
        ...
        <div className="lg:col-span-2">
          <div className="grid gap-3 lg:grid-cols-[0.92fr_1.08fr]">
            ...
            <div className="signal-marquee rounded-[24px] px-3 py-3 reveal-up reveal-delay-2" aria-label="Feature highlights">
